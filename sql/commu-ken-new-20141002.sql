...
--
-- Host: localhost
-- Generation Time: 2014 年 10 月 02 日 07:47
-- サーバのバージョン： 5.6.16
-- PHP Version: 5.5.11
...
(3, 1, 'まずは感じよく声を掛けてみよう！', 'background_classroom.jpg', '休み時間、梅野くんが同級生からマンガを返してもらっている。『梅野、これ面白かったよ！』「でしょ？」あのマンガ、妹が面白いと言っていたやつだ。読んでみたい。借りられないだろうか？　それに、借りればもっと仲良くなるきっかけになるかも？', 10);
...
('sample@gmail.com', 'sample', 4, 'adf', 'women', '2014-10-01', 0),
('san@gmail.com', 'san', 1, 'fd', 'mon', '2014-09-30', 0),
('test@gmail.com', 'test@gmail.com', 1, 'テストです', 'm', '1988-11-07', 26),
('umeno@gmail.com', 'umeno', 2, '梅野テスト', 'm', '1990-01-11', 24),
('wow@gmail.com', 'wow', 1, 'ww', 'mon', '2014-09-30', 0);
