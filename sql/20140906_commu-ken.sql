...
--
-- Host: 127.0.0.1
-- Generation Time: 2014 年 9 朁E06 日 03:34
-- サーバのバージョン： 5.6.20
-- PHP Version: 5.5.15
...
CREATE TABLE IF NOT EXISTS `faces` (
  `id` int(4) NOT NULL,
  `characters_image` varchar(100) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `stages` (`id`, `scenario_id`, `stage_name`, `bg_image`, `stage_exp`) VALUES
