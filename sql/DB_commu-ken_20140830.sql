...
--
-- Host: 127.0.0.1
-- Generation Time: 2014 年 8 朁E30 日 07:24
-- サーバのバージョン： 5.6.16
-- PHP Version: 5.5.11
...
--
-- テーブルのデータのダンプ `playhistory`
--

INSERT INTO `playhistory` (`history_id`, `answer_id`, `step_id`) VALUES
('1', '100', '10'),
('2', '100', '10');
...
INSERT INTO `step` (`step_id`, `stage_id`, `scenario_id`, `answer_id`, `answer_no`, `step_no`, `matome`) VALUES
...
INSERT INTO `user` (`user_id`, `password`, `secret_question`, `secret_answer`, `gender`, `birthday`, `age`) VALUES
