...
--
-- Host: localhost
-- Generation Time: 2014 年 9 月 16 日 19:28
-- サーバのバージョン： 5.6.16
-- PHP Version: 5.5.11
...
(56, '0', '4', 1, '1', '10', '（借りれずに立ち去る）'),
(57, '0', '4', 2, '2', '21', '会話を止めないの！　自分から話をふっておいて、途中で会話をやめるのは相手に失礼よ！'),
(58, '0', '4', 3, '2', '20', 'まず相手に質問して話のきっかけを作ったのは、すごくよかったんだから！'),
(59, '0', '4', 4, '2', '22', '黙っちゃったら、相手は「無視された」って思うから要注意！　これ基本！'),
(60, '1', '4', 1, '1', '12', 'へー。君もこういうマンガ読むの？'),
(61, '2', '4', 1, '1', '15', 'あ、いいよ！'),
(62, '2', '4', 2, '2', '27', 'ちゃんと借りられたけれど、唐突にお願いしすぎじゃない？'),
(63, '2', '4', 3, '2', '24', 'まず相手に質問して話のきっかけを作ったのはよかったけど、一方的に「貸して！」って言うだけだと怒っちゃう人もいるかもしれないわ。'),
(64, '2', '4', 4, '2', '29', 'それに、相手が説明してくれてるんだから、まずは相槌を打ったりしないと「この人、話を聴いてないな」って思われちゃうわよ？'),
(65, '3', '4', 1, '1', '12', 'いいよ！'),
(66, '3', '4', 2, '2', '21', '「じゃあ」の意味がわからないわよ！何の「じゃあ」なのよ！'),
(67, '3', '4', 3, '2', '20', 'いい？相手に質問をして話のきっかけを作ったのはすごくよかったわ。その質問を受けて、今は梅野くんがマンガの説明をしてくれてるわけでしょ？'),
(68, '3', '4', 4, '2', '22', 'だったら「ふんふん」って相槌を打ったり、相手の説明に関係する話を返したりした方がいいわよ。お願いは、相手の話をきちんと聴いてから！'),
(69, '4', '4', 1, '1', '17', 'あ、そうかな。そうかもね'),
(70, '4', '4', 2, '2', '21', '相手の言うことをいきなり否定しちゃダメ！'),
(71, '4', '4', 3, '2', '24', 'あのねえ、話を広げようして自分の意見を言うのはいいけど、相手の言ったことをいきなり否定するのはあんまり感じがよくないわ。それに、否定されると相手も話しづらくなっちゃうわね……。'),
(72, '4', '4', 4, '2', '22', '単に話を続けたいときは、「相手の話を即否定」はNG！'),
(73, '4', '4', 5, '2', '20', 'でも、まず相手に質問して話のきっかけを作ったのはよかったわ。'),
(74, '5', '4', 1, '2', '22', 'お願いごとをするときは、自分の希望を一方的に押し付けちゃダメ！'),
(75, '5', '4', 2, '2', '20', 'いきなりお願いごとをするんじゃなくて、相手が何か話してるときは、その話を遮らないようにするといいわ。「うんうん」って相づちを打つとかしてね。'),
(76, '5', '4', 3, '2', '22', '相手に「話を聴いてくれなかった」と思わせる言い方はNG！'),
(77, '5', '4', 4, '2', '28', '逆に、「聴いてくれた」って思ってくれれば、相手との距離はどんどん縮まるわ！'),
(78, '0', '5', 1, '1', '20', '（借りられずに立ち去る）'),
(79, '0', '5', 2, '2', '24', 'あああ?惜しい！ここまで話が続いたのに……。あのねえお兄ちゃん、もっと自信もっていいのよ！'),
(80, '0', '5', 3, '2', '20', 'まず質問して話のきっかけを作って、次は相手の話に関することを言って話を広げたよね。'),
(81, '0', '5', 4, '2', '28', 'そこまですごくよかったんだから。'),
(82, '0', '5', 5, '2', '23', '完璧に話せなくてもいいから、相手に質問されたら黙らないで答えて！'),
(83, '1', '5', 1, '1', '10', 'あ、ああ、うん'),
(84, '1', '5', 2, '2', '21', '質問を質問で返しちゃダメ！！向こうが何か訊いてくるときは、そのことを知りたいときなんだから、まずは答える！相手のことを訊くのはその後！'),
(85, '1', '5', 3, '2', '20', 'でも、これまでの流れは悪くなかったわ。まず質問して話のきっかけを作ったのがナイスよ。で、相手の話に関連した返しをしたのもよかったわ。'),
(86, '1', '5', 4, '2', '23', 'あと一息だから頑張って！'),
(87, '2', '5', 1, '1', '14', 'はいよー'),
(88, '2', '5', 2, '2', '24', '当初の目的を忘れないで～！　途中まではすっごく良かったのに！'),
(89, '2', '5', 3, '2', '28', 'まず「何のマンガ？」って質問して会話のきっかけを作ったのはすごくよかったわ！　その後も相手の話に関連したことを言って、話を広げられたしね。'),
(90, '2', '5', 4, '2', '23', 'あとは最後にちゃんと「お願い」をするだけ！'),
(91, '3', '5', 1, '1', '14', 'いいよ！　また感想とか聴かせてね！'),
(92, '3', '5', 2, '2', '28', 'やったよお兄ちゃん！　梅野くんと友達になれたも同然ね！　まずは質問して会話のきっかけを作ったのがよかったわ！　さらに、相手の話に関連することを言って、話を自然に広げたのもグッド！　そして最後にお願いするとき、「貸してくれない？」って「お願い」したのがすごくいい！'),
(93, '3', '5', 3, '2', '23', '「貸して！」ってきっぱり言い過ぎると、自分の希望ばっかり押し付ける感じになっちゃうからね。そういう感じを出さないようにすると、相手も好印象を持ってくれて、どんどん友達ができるわよ！'),
(94, '4', '5', 1, '1', '11', 'ああ、いいよ！'),
(95, '4', '5', 2, '2', '20', '「ほぼ」合格だね！でももっといい回答もあるわよ。'),
(96, '4', '5', 3, '2', '28', 'お兄ちゃん、ここまでの流れはすごくよかった！　まず質問して会話のきっかけを作ったのがよかったわ。その後、相手の話に関することを言って会話を繋げたのもね。'),
(97, '4', '5', 4, '2', '29', 'でも、最後の「貸して」はちょっと強引な感じがする！　一方的に「貸して！」って言うのはちょっとだけワガママな感じがするよ。「?して！」っていう気軽な言い方は、けっこう親しい友達だけにした方がいいよ！'),
(98, '4', '5', 5, '2', '24', 'でないと、人によっては「ワガママなヤツだな」と思っちゃうかも？'),
(99, '5', '5', 1, '2', '20', 'お願いごとをするときは、自分の希望を一方的に押し付けちゃダメ！　「?していい？」っていう言い方で「お願い」してみて！'),
(100, '5', '5', 2, '2', '28', 'そうすれば、自分の希望だけをワガママに押し付ける感じがなくなって、印象が良くなるわよ！');
...
('sample@gmail.com', 'sample', 1, 'asdfsagas', 'mon', '1985-06-05', 29),
('test@gmail.com', 'test@gmail.com', 1, 'テストです', 'm', '1988-11-07', 26),
('umeno@gmail.com', 'umeno', 2, '梅野テスト', 'm', '1990-01-11', 24);
