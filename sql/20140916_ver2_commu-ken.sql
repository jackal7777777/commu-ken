...
--
-- Host: 127.0.0.1
-- Generation Time: 2014 年 9 朁E16 日 13:15
-- サーバのバージョン： 5.6.20
-- PHP Version: 5.5.15
...
INSERT INTO `serif` (`id`, `answer_no`, `step_id`, `serif_no`, `character_id`, `face_id`, `serif_text`) VALUES
(1, 0, 0, 0, 0, 0, '	serif_text'),
(2, 0, 1, 1, 1, 10, '	特に話しかけないで１日終わる'),
...
(71, 4, 5, 1, 1, 17, '	あ、そうかな。そうかもね'),
(72, 4, 5, 2, 2, 21, '	相手の言うことをいきなり否定しちゃダメ！'),
(73, 4, 5, 3, 2, 24, '	あのねえ、話を広げようして自分の意見を言うのはいいけど、相手の言ったことをいきなり否定するのはあんまり感じがよくないわ。それに、否定されると相手も話しづらくなっちゃうわね……。'),
(74, 4, 5, 4, 2, 22, '	単に話を続けたいときは、「相手の話を即否定」はNG！'),
(75, 4, 5, 5, 2, 20, '	でも、まず相手に質問して話のきっかけを作ったのはよかったわ。'),
(76, 5, 5, 1, 2, 22, '	お願いごとをするときは、自分の希望を一方的に押し付けちゃダメ！'),
(77, 5, 5, 2, 2, 20, '	いきなりお願いごとをするんじゃなくて、相手が何か話してるときは、その話を遮らないようにするといいわ。「うんうん」って相づちを打つとかしてね。'),
(78, 5, 5, 3, 2, 22, '	相手に「話を聴いてくれなかった」と思わせる言い方はNG！'),
(79, 5, 5, 4, 2, 28, '	逆に、「聴いてくれた」って思ってくれれば、相手との距離はどんどん縮まるわ！'),
(80, 0, 5, 1, 1, 20, '	（借りられずに立ち去る）'),
...
(87, 1, 3, 3, 2, 20, '	でも、これまでの流れは悪くなかったわ。まず質問して話のきっかけを作ったのがナイスよ。で、相手の話に関連した返しをしたのもよかったわ。'),
(88, 1, 3, 4, 2, 23, '	あと一息だから頑張って！'),
(89, 2, 3, 1, 1, 14, '	はいよー'),
(90, 2, 3, 2, 2, 24, '	当初の目的を忘れないで～！　途中まではすっごく良かったのに！'),
(91, 2, 3, 3, 2, 28, '	まず「何のマンガ？」って質問して会話のきっかけを作ったのはすごくよかったわ！　その後も相手の話に関連したことを言って、話を広げられたしね。'),
(92, 2, 3, 4, 2, 23, '	あとは最後にちゃんと「お願い」をするだけ！'),
(93, 3, 3, 1, 1, 14, '	いいよ！　また感想とか聴かせてね！'),
(94, 3, 3, 2, 2, 28, '	やったよお兄ちゃん！　梅野くんと友達になれたも同然ね！　まずは質問して会話のきっかけを作ったのがよかったわ！　さらに、相手の話に関連することを言って、話を自然に広げたのもグッド！　そして最後にお願いするとき、「貸してくれない？」って「お願い」したのがすごくいい！'),
(95, 3, 3, 3, 2, 23, '	「貸して！」ってきっぱり言い過ぎると、自分の希望ばっかり押し付ける感じになっちゃうからね。そういう感じを出さないようにすると、相手も好印象を持ってくれて、どんどん友達ができるわよ！'),
(96, 4, 3, 1, 1, 11, '	ああ、いいよ！'),
(97, 4, 3, 2, 2, 20, '	「ほぼ」合格だね！でももっといい回答もあるわよ。'),
(98, 4, 3, 3, 2, 28, '	お兄ちゃん、ここまでの流れはすごくよかった！　まず質問して会話のきっかけを作ったのがよかったわ。その後、相手の話に関することを言って会話を繋げたのもね。'),
(99, 4, 3, 4, 2, 29, '	でも、最後の「貸して」はちょっと強引な感じがする！　一方的に「貸して！」って言うのはちょっとだけワガママな感じがするよ。「?して！」っていう気軽な言い方は、けっこう親しい友達だけにした方がいいよ！'),
(100, 4, 3, 5, 2, 24, '	でないと、人によっては「ワガママなヤツだな」と思っちゃうかも？'),
(101, 5, 3, 1, 2, 20, 'お願いごとをするときは、自分の希望を一方的に押し付けちゃダメ！　「～していい？」っていう言い方で「お願い」してみて！'),
(102, 5, 3, 2, 2, 28, 'そうすれば、自分の希望だけをワガママに押し付ける感じがなくなって、印象が良くなるわよ！');
...
(1, 1, 'とりあえず何か話しかけてみよう！', 'img_testBgImage.png', '高校２年の１学期。新しいクラス、周りは知らない人ばかり、今年こそ友達を作りたい！隣の席になった梅野くんが、何だかすごくいい人そう。友達になりたいな…', 10),
(2, 1, '梅野くんが知らない「２ちゃんねるについてわかりやすく説明しよう」', 'bg2.ping', '休み時間、一人スマホで２ちゃんねる閲覧中。”スレ立て乙……っと……”。なんてことをやっていたら、背後に梅野くんの気配！　興味深げに画面を見ながら、「ねえ、２ちゃんねるって何？」と訊いてきた。', 13),
(3, 1, 'まずは感じよく声を掛けてみよう！', 'bg.pimg', '休み時間、梅野くんが同級生からマンガを返してもらっている。『梅野、これ面白かったよ！』「でしょ？」\r\nあのマンガ、妹が面白いと言っていたやつだ。読んでみたい。借りられないだろうか？　それに、借りればもっと仲良くなるきっかけになるかも？', 10),
(4, 1, '感じよく会話を続けよう！', 'bg3.ping', '「そうそう。今流行ってるスポ根モノのマンガだよ', 14),
(5, 1, 'マンガを借りてみよう！', 'bg4.ping', '「へー。君もこういうマンガ読むの？」', 12);
...
--
-- AUTO_INCREMENT for table `serif`
--
ALTER TABLE `serif`
